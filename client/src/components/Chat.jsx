...
const Chat = ({ bookingId, receiverName, receiverPhone, socketRef, onClose }) => {
  ...
  return createPortal(
    <div className="fixed bottom-32 right-6 w-[400px] h-[600px] max-h-[80vh] bg-gradient-to-br from-slate-900 via-obsidian to-slate-900 z-[9999] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.6)] flex flex-col animate-slide-up rounded-[3rem] border border-white/10 overflow-hidden font-display">
      {/* Header */}
